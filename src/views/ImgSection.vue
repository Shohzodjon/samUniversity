...
const imgList = [
  { id: 1, img: img1, desc: "img one" },
  { id: 2, img: img3, desc: "img two" },
  { id: 3, img: img2, desc: "img three" },
  { id: 4, img: img4, desc: "img four" },
  { id: 5, img: img5, desc: "img five" },
];
</script>
<style scoped>
.img__section {
